...
namespace Blaze.Modules
{
    class BlazeHelpMenu : BModule
    {
        ...
        {
            Menu = new QMNestedButton(BlazeMenu.MainMenu, "", 0, 0, "", "Blaze's Help Menu");
            Menu.GetMainButton().SetActive(false);
            slides = new();
            openObject = BlazeMenu.MainMenu.GetMenuObject().transform.Find("Header_H1/RightItemContainer/Button_QM_Expand").gameObject;
...
<b>Left Ctrl + Middle Mouse Button</b> - <color=yellow>Reset FOV</color>");
            ...
            //Logs.Log($"Slides Count: {slides.Count}");
        }
