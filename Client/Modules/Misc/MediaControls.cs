...
{
    class MediaControls : BModule
    {
        private static string LastLoggedSong = string.Empty;

        #region WMC Functions
        private static ProcessStartInfo startInfo = new(ModFiles.WMCFile)
        {
        ...
        internal static List<CurrentStatus> currentSources = new() { new CurrentStatus() };
        internal static int currentlyViewing = 0;
        ...
        internal static void ProcessSourceChange(SourceChange sourceChanged)
        {
            try
            {
                /*string str = "SRC:\t";
        ...
        internal static void ProcessSongChange(SongChange song)
        {
            try
            {
                //string str = "SNG:\t";
        ...
        internal static void ProcessPlaybackChanged(PlaybackChange playback)
        {
            try
            {
                //string str = "PLY:\t";
        ...
        internal static void MaxWindowSize()
        {
        ...
        internal static void ChangeSource(int value)
        {
            try
            {
        ...
        internal static void ProcessPlayerCommands(Commands command)
        {
            try
            {
