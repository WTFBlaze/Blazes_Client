...
namespace Blaze.Utils.Discord
{
    public class DiscordRichPresence
    {
        private const string V = "Blaze/Dependencies/DiscordRPC";
        ...
        // Calls For Discord-RPC "THAT YOU NEED" For This DiscordRPC To Work
        // If You Dont You Will Get A Error Saying Your Are Missing discord-rpc

        [DllImport(V, EntryPoint = "Discord_Initialize", CallingConvention = CallingConvention.Cdecl)]
        public static extern void Initialize(string applicationId, ref EventHandlers handlers, bool autoRegister, string optionalSteamId);

        [DllImport(V, EntryPoint = "Discord_Shutdown", CallingConvention = CallingConvention.Cdecl)]
        public static extern void Shutdown();

        [DllImport(V, EntryPoint = "Discord_RunCallbacks", CallingConvention = CallingConvention.Cdecl)]
        public static extern void RunCallbacks();

        [DllImport(V, EntryPoint = "Discord_UpdatePresence", CallingConvention = CallingConvention.Cdecl)]
        private static extern void UpdatePresenceNative(ref RichPresenceStruct presence);

        [DllImport(V, EntryPoint = "Discord_ClearPresence", CallingConvention = CallingConvention.Cdecl)]
        public static extern void ClearPresence();

        [DllImport(V, EntryPoint = "Discord_Respond", CallingConvention = CallingConvention.Cdecl)]
        public static extern void Respond(string userId, Reply reply);

        [DllImport(V, EntryPoint = "Discord_UpdateHandlers", CallingConvention = CallingConvention.Cdecl)]
        ...
        public class RichPresence
        {
            ...
            public RichPresenceStruct GetStruct()
            {
                if (_buffers.Count > 0)
                {
                    FreeMem();
