...
namespace Blaze.API
{
    public static class APIStuff
    {
        ...
        public static Action<BaseWing> OnWingInit = _ => { };
        ...
        public static NotificationMoreActionsModal GetNotificationsInstance()
        {
            return GameObject.Find("UserInterface/Canvas_QuickMenu(Clone)/Container/Window/QMParent/Modal_QM_MoreActions").GetComponent<NotificationMoreActionsModal>();
        }
