...
namespace Blaze.Modules
{
    class AmongUs : BModule
    {
        ...
        {
            Menu = new QMNestedButton(BlazeQM.WorldSpecific, "Among Us", 1, 0, "Click to view functions for Among Us", "WS - Among Us");
            ...
            new QMSingleButton(Menu, 4, 0, $"<color={Colors.AquaHex}>Crewmates\nWin</color>", delegate
            {
            ...
            new QMSingleButton(Menu, 4, 1, $"<color={Colors.MagentaHex}>All\nSkip", delegate
            {
