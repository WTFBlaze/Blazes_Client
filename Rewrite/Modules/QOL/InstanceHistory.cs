...
{
    public class InstanceHistory : BModule
    {
        ...
        {
            Menu = new QMNestedButton(BlazeQM.Worlds2, "Instance\nHistory", 1, 0, "View and rejoin previous worlds you have been to", "Instance History");
        ...
        public override void LocalPlayerLoaded()
        {
            ...
            {
                Config.InstanceHistory.list.MoveItemAtIndexToFront(Config.InstanceHistory.list.FindIndex(x => x.JoinID == WorldUtils.GetJoinID()));
                Config.InstanceHistory.Save();
            }
        }
    }
