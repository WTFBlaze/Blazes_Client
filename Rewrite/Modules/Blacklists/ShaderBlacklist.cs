...
{
    public class ShaderBlacklist : BModule
    {
        ...
        {
            Menu = new QMNestedButton(BlazeQM.Security, "Shader\nBlacklist", 3, 2, "Click to view all shaders you have blacklisted", "Shader Blacklist");
        ...
        public static void AddOrRemoveFromList(string shader)
        {
